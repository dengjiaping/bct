...
import cn.antke.bct.network.entities.ShareMemberEntity;
import cn.antke.bct.person.adapter.ShareMemberAdapter;
...
public class ShareMemberActivity extends ToolBarActivity {
	...
	private void initData() {
		...
		ShareMemberAdapter adapter = new ShareMemberAdapter(this, entityList);
