...
import cn.antke.bct.person.controller.IntegralPwdActivity;
...
public class DialogUtils {
	...
	* content 和contentSsb一个只能填一个*/
	...
	public static void showPwdInputDialog(Context context,DialogEtClickListenner dialogEtClickListenner) {
		...
		closeView.setOnClickListener(v -> closeDialog());
